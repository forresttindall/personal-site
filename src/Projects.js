...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "A dynamic photography showcase built with React and PhotoSwipe. This responsive image gallery features high-performance image loading with WebP optimization, smooth transitions, and an elegant lightbox viewing experience.",
      image: "/images/photography.jpg",
      technologies: ["React.js", "PhotoSwipe", "Vercel"],
      categories: ["web", "design"],
      link: "https://forresttindall.com",
    ...
    },
    {
      ...
      {
        title: "WiGLE Batch Uploader, HeatMap, & Badge Generator",
        description: "The WiGLE Uploader is a tool that allows users to upload multiple files to WiGLE.net at once, creates heatmaps of user data, and generates badges for their contributions and stats.",
        image: "/images/wiglenew.jpg",
        technologies: ["React", "html2canvas", "RPC API", "Google Maps API"],
